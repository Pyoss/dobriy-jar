...
if (Loader::includeModule('search') && !$arParams['FOUND_ELEMENTS']) {
    $arElements = $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "arrWHERE" => array(),
            "SHOW_WHEN" => "N",
            "PAGE_RESULT_COUNT" => (isset($arParams["PAGE_RESULT_COUNT"]) ? $arParams["PAGE_RESULT_COUNT"] : 15),
            "DISPLAY_TOP_PAGER" => "N",
...
} else if ($arParams['FOUND_ELEMENTS']){
    $arElements = $arParams['FOUND_ELEMENTS'];
...
$APPLICATION->IncludeComponent(
    "dj_components:catalog.sections_filter",
    "",
    array('ELEMENTS_ARRAY' => $arElements),
    $component,
    array('HIDE_ICONS' => 'Y'),
);
?>
...
if (!empty($searchFilter) && is_array($searchFilter)) {
    $componentParams = array(
            ...
            'VIEW_MODE' => (isset($arParams['VIEW_MODE']) ? $arParams['VIEW_MODE'] : 'row-view')
        ) + $elementOrder;
