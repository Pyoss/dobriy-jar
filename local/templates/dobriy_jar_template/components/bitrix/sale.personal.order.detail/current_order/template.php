...
if (!empty($arResult['ERRORS']['FATAL'])) {
    ...
    <div class="history__order">
        ...
        <span class="history__order-status"><?= $arResult["STATUS"]['NAME'] ?></span>
        ...
        <? foreach ($arResult['PAYMENT'] as $payment) {
            ...
            <div class="history__payment-details">
                ...
                if ($payment['PAID'] === 'Y') {
                    ?>
                    <span class="history__payment-success">Оплачено</span>
                    <?
                } elseif ($arResult['IS_ALLOW_PAY'] == 'N') {
                    ?>
                    <span class="history__payment-restricted">Оплата заболкирована</span>
                    <?
                } else {
                    ?>
                    <span class="history__payment-unpaid">Не оплачено</span>
                    <?
                }
                ?>
            </div>
