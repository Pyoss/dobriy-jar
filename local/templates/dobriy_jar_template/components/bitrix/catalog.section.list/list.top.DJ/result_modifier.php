...
{
    $SECTION_PIC_HEIGHT = 75 ;
    $SECTION_PIC_WIDTH = 75 ;
	$boolPicture = false;
	$boolDescr = false;
	$arSelect = array('ID');
	$arMap = array();
    ...
    foreach ($arResult['SECTIONS'] as $key => $arSection) {
        $arResult['SECTIONS'][$key]['DETAIL_PICTURE'] = CFile::ResizeImageGet($arSection["DETAIL_PICTURE"], array("width"=>$SECTION_PIC_HEIGHT, "height"=>$SECTION_PIC_WIDTH), BX_RESIZE_IMAGE_PROPORTIONAL, true);
    }
}
?>