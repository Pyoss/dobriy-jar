            ...
            <div class="regform">
                ...
                <? foreach ($arResult["SHOW_FIELDS"] as $FIELD): ?>
                    <? if ($FIELD == "AUTO_TIME_ZONE" && $arResult["TIME_ZONE_ENABLED"] == true): ?>
                        ...
                        <div class="regform__timezonereg">
                    ...
                    <? else: ?>
                        <div class="regform__field">
                            <span class="regform__field-title"><?= GetMessage("REGISTER_FIELD_" . $FIELD) ?>:<? if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?>
                                    <span class="starrequired">*</span><? endif ?></span>
                            <div class="regform__field-content"><?
                                switch ($FIELD) {
                                    case "PASSWORD":
				...
				<span class="bx-auth-secure" title="<? echo GetMessage("AUTH_NONSECURE_NOTE") ?>">
					<div class="bx-auth-secure-icon bx-auth-secure-unlock"></div>
                                ...
                                if ($FIELD == "PERSONAL_BIRTHDAY"): ?>
                                    ...
                                    ?><input <? if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"): ?>
                                    required<? endif ?> size="30" type="text" name="REGISTER[<?= $FIELD ?>]"
                ...
                <? if ($arResult["USER_PROPERTIES"]["SHOW"] == "Y"): ?>
                    <div class="regform__title"><?= trim($arParams["USER_PROPERTY_NAME"]) <> '' ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB") ?></div>
                    <? foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField): ?>
                        <div class="regform__field-content"><?= $arUserField["EDIT_FORM_LABEL"] ?>
                ...
                /* !CAPTCHA */
                ?>
                <div class="regform__submit">
                    <input class="dj-button" type="submit" name="register_submit_button" value="<?= GetMessage("AUTH_REGISTER") ?>"/>
                </div>
