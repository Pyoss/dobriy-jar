...
<div class="dj-filter">
	...
	<div class="filter-container">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
						...
						<div class="bx-filter-block" data-role="bx_filter_block">
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
									...
									<div class="col-xs-12">
										...
										<?foreach ($arItem["VALUES"] as $val => $ar):?>
											...
											if ($ar["DISABLED"])
												$class.= " disabled";
											?>
											<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label <?=$class?>" onclick="smartFilter.keyup(); BX.toggleClass(this, 'bx-active');">
								...
								case "H"://CHECKBOXES_WITH_PICTURES_AND_LABELS
									...
									break;
								case "P"://DROPDOWN?>
                                    <select name="select" type="dropdown" id="<?=$arCur["CONTROL_ID"]?>"
                                            onchange="smartFilter.change_dropdown(this, <?=$arCur["CONTROL_ID"]?>)"
										...
										<div class="bx-filter-parameters-box-container-block"><div class="bx-filter-input-container bx-filter-calendar-container">
											<?$APPLICATION->IncludeComponent(
												...
												array(
													...
													'SHOW_INPUT' => 'Y',
													'INPUT_ADDITIONAL_ATTR' => 'class="calendar" placeholder="'.FormatDate("SHORT", $arItem["VALUES"]["MIN"]["VALUE"]).'" onkeyup="smartFilter.keyup()" onchange="smartFilter.keyup()"',
										...
										<div class="bx-filter-parameters-box-container-block"><div class="bx-filter-input-container bx-filter-calendar-container">
											<?$APPLICATION->IncludeComponent(
												...
												array(
													'FORM_NAME' => $arResult["FILTER_NAME"]."_form",
													'SHOW_INPUT' => 'Y',
													'INPUT_ADDITIONAL_ATTR' => 'class="calendar" placeholder="'.FormatDate("SHORT", $arItem["VALUES"]["MAX"]["VALUE"]).'" onkeyup="smartFilter.keyup()" onchange="smartFilter.keyup()"',
            ...
            <div class="bx-action-wrapper" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?>>
