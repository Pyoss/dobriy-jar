...
?>
    <div class="sales-detail center-content">
...
<? if ($arParams["DISPLAY_DATE"] != "N" && $arResult["DISPLAY_ACTIVE_FROM"]): ?>
    <span class="sales-date-time"><?= $arResult["DISPLAY_ACTIVE_FROM"] ?></span>
<? endif; ?>
<? if ($arParams["DISPLAY_NAME"] != "N" && $arResult["NAME"]): ?>
    <h3 class="sales-title"><?= $arResult["NAME"] ?></h3>
    </div>
<? endif; ?>
...
<? foreach ($arResult["FIELDS"] as $code => $value):
    ...
    ?><br/>
<?endforeach;
$elementIDs = $arResult['PROPERTIES']['BIND_ELEMENTS']['VALUE'];
if ($elementIDs):
    ?>
