...
<form name="bform" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
    <div class="forgotpswd">
        ...
        <div class="forgotpswd__field">
            <div class="forgotpswd__field-title">Введите Ваш логин или email</div>
            <div class="forgotpswd__field-content">
        ...
        <div style="margin-top: 20px">
            <input class="dj-button" type="submit" name="send_account_info" value="<?= GetMessage("AUTH_SEND") ?>"/>
        </div>
        <div style="margin-top: 16px">
