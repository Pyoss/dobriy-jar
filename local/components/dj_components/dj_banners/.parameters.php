...
if ($arCurrentValues['BANNER_TYPE'] == 'popular' || $arCurrentValues['BANNER_TYPE'] == 'popular_2'){
...
} else if ($arCurrentValues['BANNER_TYPE'] == 'blog'){
    $arComponentParameters['PARAMETERS']['ARTICLE_ID'] = array(
        "PARENT"=> 'BASE',
        "NAME" => 'ID Статей',
        "TYPE" => "INTEGER",
        "MULTIPLE" => "Y");
